  ...
  return (
    <>
        ...
        <div className="row w-100 align-items-center">
            ...
            <div className="col h-100">
            <p className="text-muted text-start fs-4 font-weight-light">Basically, MobX is a popular JS state management library.</p>
            <p className="fs-4 text-start mt-5">The philosophy behind MobX is described as:</p>
